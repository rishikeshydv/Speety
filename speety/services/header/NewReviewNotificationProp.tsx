...
const NewReviewNotificationProp:React.FC<NotificationProps> = ({id,type,from,date}) => {
  ...
  , []);
    ...
    return (
      <div className="w-full group flex flex-col gap-4 border bg-blue-100 border-gray-200 rounded-lg dark:border-gray-800">
  ...
  export default NewReviewNotificationProp;
