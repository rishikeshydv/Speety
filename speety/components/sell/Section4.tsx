  ...
  return (
    <div><section className="bg-gray-200 py-40">
        ...
        <AccordionItem value="item-1">
          <AccordionTrigger className="border-2 border-black mt-6 rounded-2xl px-10 text-lg">When selling my house, where should I begin?</AccordionTrigger>
        ...
        <AccordionTrigger className="border-2 border-black rounded-2xl px-10 text-lg">How long does it take to sell a house?</AccordionTrigger>
          <AccordionContent  className="text-md px-4 py-3 italic">
        ...
        <AccordionTrigger className="border-2 border-black rounded-2xl px-10 text-lg">What home seller mistakes should I avoid?</AccordionTrigger>
          <AccordionContent  className="text-md px-4 py-3 italic">
          On average, homes in the U.S. spend about one month on the market before going under contract, and another month or more to close. In 2020, the average time to sell a home was 55-70 days from list to close.
          </AccordionContent>
        </AccordionItem>
