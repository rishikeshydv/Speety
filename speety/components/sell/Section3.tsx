  ...
  return (
    <div>
        ...
        <section className='py-52'> 
            ...
            <div className='flex items-center justify-center mt-20'><button className='text-white bg-black rounded-2xl px-10 h-24 w-80 text-3xl font-bold uppercase'><a href="/post">Post for sale</a></button></div>
