  ...
  return (
    <div>
      <section className="mb-10 mt-10">
        <ContainerScroll
          titleComponent={
            <div className="flex flex-col justify-center items-center pb-5 md:px-16 mt-6 xl:mt-0 2xl:mt-0">
              <div className="text-[#508991] py-1 px-5 border border-blue-200 border-opacity-20 text-lg font-semibold tracking-tighter xl:mb-10 2xl:mb-10">
              ...
              <div className="flex flex-col items-center gap-y-4 pb-4 ">
                <div className="text-lg font-light text-gray-600" >Trusted by top founders all over the world.</div>
                <div className="flex">
              ...
              {/* Get started button */}
              <button
                className="bg-[#397367] hover:bg-gray-900 font-medium text-white px-8 py-2 rounded-[30px] shadow-lg md:h-12 2xl:h-14 flex items-center space-x-2 text-lg 2xl:text-lg mb-4 md:mb-10"
                onClick={loginDirect}
              >
