  ...
  <div className="flex justify-center items-center min-h-screen">
      <div className="flex items-center justify-center w-full md:gap-5 gap-3 px-6 lg:flex-row flex-col">
        <div className="w-full h-full flex items-center flex-col gap-5 justify-center">
          <span className=" font-sans lg:text-3xl md:text-2xl text-xl text-[#2E1760] font-bold">
          <a href="/"><h1 className="text-6xl">Speety</h1></a>
          </span>
          <form onSubmit={handleSubmit(onSubmit)} className="w-full max-w-md mx-auto">
            <div className="flex flex-col gap-4 w-full">
              ...
              <button className="items-center w-full flex justify-center cursor-pointer bg-neutral-700 py-2 rounded-lg transition duration-500 hover:bg-[#2E1760]">
