  ...
  return (
    <div>
        ...
        <section className='py-20'>
          <form onSubmit={onSubmitHandler} className='grid grid-rows-2 items-center justify-center'>
            <input type="text" onChange={onChangeHandler} className={`shadow-lg rounded-xl border-2 h-20 px-10 text-2xl text-center`} placeholder="Enter your issue ..." style={{width:1000}}/>
            <button type="submit" className={` bg-gray-300 text-2xl px-2 py-2 rounded-xl uppercase font-bold w-40 h-16 mt-6 ml-96`}>Search</button>
          </form>
        </section>
