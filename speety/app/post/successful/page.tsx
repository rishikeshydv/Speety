  ...
  return (
    <div className={poppins.className}>
      ...
      >
        ...
        <img src="/posted.webp" alt="" className="w-32 h-32 p-4" />
        <h1 className="text-6xl font-semibold text-center p-4">Your property has been posted!</h1>
        <h1 className="text-2xl text-center p-4">Refresh to view the change. </h1>
        <div className="flex gap-8">
        <Button size='lg' className="text-lg bg-gray-500"><Link href={"/"}>Return to Site</Link></Button>
        <Button size='lg' className="text-lg bg-gray-500"><Link href={"/post"}>Back to Posting</Link></Button>
        </div>
        </div>
      </div>
    </div>
