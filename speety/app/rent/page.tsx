  ...
  return (
    <div className={poppins.className}>
      ...
      <div className="">
        ...
        <img src="/wide1.jpg" alt="alt" className="aspect-video object-cover object-center w-full" style={{height:400}}/>
          <section className="py-10 flex flex-col items-center justify-center absolute left-1/4 bottom-1/4 top-30">
            {/* "Selling fast" */}
