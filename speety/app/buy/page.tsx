          ...
          <div className="flex items-center justify-center gap-6 md:gap-20">
            <div className="flex flex-col md:flex-row items-center justify-between gap-8 xl:gap-20 px-4 py-12 xl:px-6 xl:py-16 lg:px-8 lg:py-20">
              <div className="flex-1 space-y-4 max-w-md md:max-w-xl">
                <div className="text-2xl font-bold sm:text-4xl md:text-6xl xl:text-5xl text-gray-400">
                  Buying your house with{" "}
                  <h1 className="text-[#397367] text-2xl font-bold sm:text-4xl md:text-6xl xl:text-5xl">
                    confidence
                  </h1>
                </div>

                <p className="text-muted-foreground text-xs md:text-lg tracking-tight">
                  Buying a property is a big decision. We are here to help you
                  make the right choice. Our website provides you with the best
                  options for buying your home. We have a wide range of
                  properties. We help you find the best property that suits your
                  needs. We provide you with the best experience in buying your
                  home.
                </p>
              </div>
              <video
                className="flex-1 md:w-[600px] h-full overflow-hidden [background:linear-gradient(45deg,#172033,theme(colors.slate.800)_50%,#172033)_padding-box,conic-gradient(from_var(--border-angle),theme(colors.slate.300/.48)_80%,_theme(colors.green.500)_86%,_theme(colors.green.300)_90%,_theme(colors.green.500)_94%,_theme(colors.green.600/.48))_border-box] rounded-2xl border-4 border-transparent animate-border"
                autoPlay
                muted
                playsInline
              >
          ...
          <div>
                ...
                <div className="flex flex-col md:flex-row items-center justify-between xl:mb-8 2xl:mb-8">
                  <div className="space-y-1">
                    ...
                    <p className="text-gray-500 dark:text-gray-400">
                      ...
                      {Math.min(indexOfLastItem, totalResults)} of{" "}
            ...
            <section className="flex flex-col items-center space-y-8 py-8 bg-gray-200 rounded-2xl">
              <div className="flex gap-6 xl:gap-20">
                <div className="flex flex-col md:flex-row items-center justify-between gap-8 px-4 py-12 md:px-6 md:py-16 lg:px-8 lg:py-20">
                  <div className="flex-1 space-y-4 max-w-xl">
                    <h1 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl text-[#397367]">
                      Locate Your Property
                    </h1>
                    <p className="text-muted-foreground md:text-lg">
                      We have made it easier for you to locate each property on
                      the website. Each search result is marked on the map
                      below. To have a closer look into the location of the
                      property, you can click on the property to view the
                      virtual tour of the property. We provide you with the best
                      experience in buying your home.
                    </p>
                  </div>
                  <img
                    src="/svgs/14.png"
              ...
              <div className="bg-white p-3 xl:p-6 2xl:p-6 rounded-3xl">
                <div
                  className="w-[350px] h-[600px] shadow-lg md:w-[700px] md:h-[550px] xl:w-[1000px] xl:h-[550px] 2xl:w-[1000px] 2xl:h-[550px]"
